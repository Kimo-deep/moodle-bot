...
المطلوب:
تنظيم البيانات الأكاديمية التالية في تقرير احترافي، مرتب، مختصر، وسهل القراءة.
...
- ميّز أسماء الواجبات والاختبارات والمحاضرات بشكل واضح.
- في الاختبارات:
  • اعرض وقت الفتح ووقت الإغلاق إذا كانا متوفرين.
  • إذا كان الوقت مكتوباً كنطاق (مثل 2:00 PM - 2:20 PM) اعتبر الأول وقت الفتح والثاني وقت الإغلاق.
- في الواجبات والتكاليف:
  • اعرض موعد الإغلاق أو التسليم فقط إن وجد.
- لا تكرر الوقت أو التاريخ داخل نفس العنصر.
- إذا وُجد أكثر من وقت لنفس العنصر اختر البيانات الصحيحة والأوضح فقط.
- لا تعرض أي ملاحظات، تعليمات، أو تفاصيل تسليم.
- احذف أي نص متعلق بـ:
  • ملاحظات التسليم
  • التعليمات
  • طريقة الرفع
  ...
  • Moodle
  • WhatsApp
  • أي شرح إضافي غير أساسي
- افصل بين المواد المتشابهة إذا اختلف المدرس أو الشعبة.
- لا تدمج المواد إلا إذا كانت جميع البيانات متطابقة.
- أضف مسافة فارغة بين كل تكليف أو اختبار أو تجربة لزيادة الوضوح.
- إذا لم تتوفر معلومة معينة لا تذكرها.
- استخدم تنسيقاً نظيفاً مع عناوين ومسافات واضحة.
- إذا لم يوجد محتوى داخل تصنيف معين اكتب: "لا يوجد".
