...
def run_moodle_engine(user, pwd):
    ...
    try:
        ...
        prompt = f"""
        رتب هذا التقرير الأكاديمي. لا تغير التصنيفات. اجعله مختصراً. اكتب اسم المادة واسم المدرس ومعلومات الفتح والاغلاق إن وجد. اجعل اسم الواجبات والاختبارات مميزة. تأكد من صحة البيانات قبل الارسال. افصل التصنيفات المتشابهة اذا كان الاسم مختلف او المدرس مختلف. :
