...
def run_moodle_engine(user, pwd):
    ...
    try:
        ...
        prompt = f"""
        رتب هذا التقرير الأكاديمي. لا تغير التصنيفات. اجعله مختصراً. اكتب اسم المادة واسم المدرس. تأكد من صحة البيانات قبل الارسال. افصل المساقات اذا كان الاسم مختلف او المدرس مختلف. اضف معلومات الفتح والاغلاق إن وجد :
