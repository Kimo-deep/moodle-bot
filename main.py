...
اجعل مسافة بين المعلومة والاخرى مثلا لا تجهل التكاليف ملتصقة في بعضها البعض اجعل بينهم مسافة لمعرفة ان هذا تكليف يختلف عن الذي قبله نفذ هذا الامر على كل التصنيفات الموجودة
        """
