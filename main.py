...
5. ميّز الواجبات والاختبارات بعلامات واضحة.
6. افصل بين المواد المتشابهة إذا اختلف المدرس أو الشعبة.
7. احذف التكرار غير الضروري.
8. اجعل التقرير مختصراً لكن شاملاً للمعلومات المهمة.
9. لا تكتب أي شرح إضافي خارج التقرير.
10. استخدم تنسيقاً مرتباً مع مسافات وعناصر نقطية.
